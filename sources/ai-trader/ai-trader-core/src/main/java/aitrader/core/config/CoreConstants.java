...
public final class CoreConstants
{
	...
	public static final String DEFAULT_USER_FOLDER_SSH = System.getProperty("user.home") + File.separatorChar;
	...
	public static final String PRIVATEKEY_FILENAME = ".ssh/bian_private.cfg";
	public static final String PROPERTIES_FILENAME = ".ssh/ai-trader-core.cfg";
	public static final String TELEGRAM_FILENAME = ".ssh/telegram.cfg";
